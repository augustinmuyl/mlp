...
The goal of this project is to build and train MLPs without using any deep learning libraries (TensorFlow, PyTorch), to understand the internals of neural networks. The repo includes:
